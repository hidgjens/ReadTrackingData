...
data_dir        = "msgpk_ex/"       #   relative path to data directory
match_id        = 1059764       #   integer MatchID, not "g1059714"
...
total_frames    =   loaded_match.frame_count()

loaded_match.remove_dead_frames()

new_total_frames    =   loaded_match.frame_count()

print("Before: {} After: {} Change: {}".format(total_frames, new_total_frames, (total_frames - new_total_frames)))
